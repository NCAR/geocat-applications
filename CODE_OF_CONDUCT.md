...
We, as contributors, creators, stewards, and maintainers (participants), of GeoCAT-applications pledge to make participation in our software, system or hardware project and community a safe, healthy, open, productive, and harrassment-free experience for everyone, protected under applicable US federal or state law.
...
- All participants are treated with respect and consideration, valuing various views and opinions
...
This Code of Conduct applies to all spaces managed by GeoCAT-applications whether they be physical, online or face-to-face. This includes project code, code repository, associated web pages, documentation, mailing lists, project websites and wiki pages, issue tracker, meetings, telecons, events, project social media accounts, and any other forums created by the project team which the community uses for communication. In addition, violations of this Code of Conduct outside these spaces may affect a person's ability to participate within them. Representation of a project may be further defined and clarified by project maintainers.
